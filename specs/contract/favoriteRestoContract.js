const itActsAsFavoriteRestoModel = (favoriteResto) => {
  ...
  it('should be able to search for restos', async () => {
    favoriteResto.putResto({ id: 1, title: 'warung a' });
    favoriteResto.putResto({ id: 2, title: 'warung b' });
    favoriteResto.putResto({ id: 3, title: 'warung abc' });
    favoriteResto.putResto({ id: 4, title: 'ini mah warung abcd' });

    expect(await favoriteResto.searchRestos('warung a')).toEqual([
      { id: 1, title: 'warung a' },
